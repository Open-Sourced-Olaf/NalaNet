...
cp "${DIR}/../test-network/organizations/peerOrganizations/org1.example.com/connection-org1.yaml" "${DIR}/organizations/ga/gateway/"
cp "${DIR}/../test-network/organizations/peerOrganizations/org2.example.com/connection-org2.yaml" "${DIR}/organizations/pa/gateway/"
...
echo "./organizations/pa/configuration/cli/monitordocker.sh net_test"
